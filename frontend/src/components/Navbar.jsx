...
export default function Navbar({ backendOnline }) {
  return (
    <header className="bg-white/95 backdrop-blur-md border-b border-[#E5E7EB] px-10 py-5 flex items-center justify-between sticky top-0 z-40">
      <div className="flex items-center space-x-3.5">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 font-semibold tracking-wider uppercase mt-0.5">AI-Powered SQL Workspace</p>
        </div>
      </div>
